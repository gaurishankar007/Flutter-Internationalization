...
abstract class AppLocalization {
  ...
  /// No description provided for @flutterInternationalization.
  ///
  /// In en, this message translates to:
  /// **'Flutter Internationalization'**
  String get flutterInternationalization;
...
class _AppLocalizationDelegate extends LocalizationsDelegate<AppLocalization> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['en', 'es', 'hi', 'ne'].contains(locale.languageCode);
